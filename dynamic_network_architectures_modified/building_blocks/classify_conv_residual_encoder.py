...
from dynamic_network_architectures.building_blocks.attention import StackedResidualBlocksWithAttention, StackedConvBlocksWithAttention
...
class ClassifyConvResidualEncoder(nn.Module):
    def __init__(self,
                 input_channels: int,
                 n_stages: int,
        ...
        for s in range(n_stages):
            ...
            stage = StackedResidualBlocksWithAttention(
