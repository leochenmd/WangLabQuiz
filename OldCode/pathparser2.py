...
outfile = '/Users/Leo/Documents/Stanford Sensitive/ProstateData/biopsypath/parsed2.csv'
...
for index, row in df.iterrows():
    if index == 34:
        ...
        exclusions = ['turp', 'prostatectomy', 'lymph node', 'transurethral']
    ...
    #    print(grosslines)
        ...
        if len(errormsgs) > 0 and not ('core length' in errormsgs):
            primary = secondary = total = coreindex = corelength = -1
